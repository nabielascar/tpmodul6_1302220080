    ...
    internal class Program
    {
        public class SayaTubeVideo
        {
            ...
            public SayaTubeVideo(String title)
            {
                ...
                try
                {
                    checked
                    {
                        ...
                        {
                            throw new ArgumentException("Judul tidak boleh melebihi 100 karakter");
                        }
                        this.title = title;
                ...
                if (this.title != null)
                {
                    ...
                    try
                    {
                        checked
                        {
                            ...
                            {
                                throw new OverflowException("Jumlah Play Count melebihi max value");
                            }
            ...
            static void Main(string[] args)
            {
                ...
                /*try
        {
            SayaTubeVideo errTest = new SayaTubeVideo(judul);
